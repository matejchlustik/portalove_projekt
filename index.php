    ...
    <div class="container-fluid">
        <main class="tm-main">
            ...
            <div class="row tm-row">
                ...
                <article class="col-12 col-md-6 tm-post">
                    <hr class="tm-hr-primary">
                    <a href="post.php" class="effect-lily tm-post-link tm-pt-20">
                        <div class="tm-post-link-inner">
                ...
                <article class="col-12 col-md-6 tm-post">
                    ...
                    <p class="tm-pt-30">
                        ...
                        <br>For example, <a href="https://www.free-css.com/free-css-templates/page272/xtra-blog" target="_blank">Free-CSS</a> redistributed this Xtra Blog template on their website without asking any permission. It is an illegal act by Free-CSS website doing an unauthorized reposting.
                    </p>
                    <div class="d-flex justify-content-between tm-pt-45">
